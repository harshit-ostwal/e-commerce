    ...
    <div className="flex flex-col gap-20 py-20">
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <Heading size="h6" className={"text-muted-foreground"}>
          EzStore was founded with a single belief — great products should be
          accessible to everyone, everywhere. We cut through the noise and bring
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="flex flex-col gap-5">
          ...
          <Heading size="h6" className={"text-muted-foreground"}>
            We built EzStore because online shopping had become complicated —
            too many tabs, too many doubts, too much friction. Our mission is to
            deliver a seamless, transparent, and delightful shopping experience
            from the moment you land on our site to the moment your parcel
            arrives at your door.
          </Heading>
          <Heading size="h6" className={"text-muted-foreground"}>
            We work directly with brands and independent makers to bring you
            authentic, competitively-priced products — no middle-men, no hidden
            fees.
          </Heading>
        </div>
