            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <Heading size="p" className={"text-muted-foreground"}>
                  {Math.floor(rating * 10) / 10} ({reviews.length})
                </Heading>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                {tags.map((tag, idx) => (
                  <Badge key={idx} variant="secondary" className={"h-10 px-4"}>
                    {tag
                      .split(" ")
                      .map(
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Heading size="h3" className="text-primary font-semibold">
                  ${discountPrice}
                </Heading>
                <Heading
                  size="h5"
                ...
                {ProductDetailInfo(product).map((info, idx) => (
                  ...
                  >
                    ...
                    <Heading
                      key={idx}
                      size="p"
                      className={"text-foreground w-full line-clamp-2"}
                    >
